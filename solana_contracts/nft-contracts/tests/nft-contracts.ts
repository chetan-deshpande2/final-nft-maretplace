...
import { NftContracts } from '../target/types/nft_contracts';
import {
  TOKEN_PROGRAM_ID,
  MINT_SIZE,
...
describe('nft-contracts', () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());

  //retrive the TokenContract struct from our smart contract
  const program = anchor.workspace.NftContracts as Program<NftContracts>;
