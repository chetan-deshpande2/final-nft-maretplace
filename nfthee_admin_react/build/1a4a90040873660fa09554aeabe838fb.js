...
ace.define("ace/mode/css/csslint", [], function (require, exports, module) {
  var CSSLint = function () {
      ...
      require = function () {
        ...
        3: [function (require, module, exports) {
          ...
          Matcher.many = function (required) {
            ...
            var result = new Matcher(function (expression) {
              var seen = [],
                max = 0,
                pass = 0;
              var success = function success(matchCount) {
                if (pass === 0) {
              ...
              var tryMatch = function tryMatch(matchCount) {
          ...
          Matcher.prototype = {
            ...
            braces: function braces(min, max, marker, optSep) {
              var m1 = this,
          ...
          Parser.prototype = function () {
            var proto = new EventTarget(),
              ...
              additions = {
                ...
                _supports: function _supports(emit) {
                  var tokenStream = this._tokenStream,
                    line,
                    col;
                ...
                _supports_declaration_condition: function _supports_declaration_condition(requireStartParen) {
                  var tokenStream = this._tokenStream;
        ...
        17: [function (require, module, exports) {
          ...
          TokenStream.prototype = mix(new TokenStreamBase(), {
            ...
            _getDefaultToken: function _getDefaultToken(c, startLine, startCol) {
            ...
            readUnquotedURL: function readUnquotedURL(first) {
              var reader = this._reader,
                url = first || "",
                c;
            ...
            readEscape: function readEscape(first, unescape) {
              var reader = this._reader,
                cssEscape = first || "",
                i = 0,
                c = reader.peek();
        ...
        19: [function (require, module, exports) {
          ...
          var Validation = module.exports = {
            ...
            singleProperty: function singleProperty(types, expression) {
              var result = false,
        ...
        21: [function (require, module, exports) {
          ...
          copy(ValidationTypes, {
            ...
            describe: function describe(type) {
            ...
            simple: {
              ...
              "<animateable-feature-name>": function animateableFeatureName(part) {
              ...
              "<color-svg>": function colorSvg(part) {
              ...
              "<glyph-angle>": function glyphAngle(part) {
              ...
              "<ident-not-generic-family>": function identNotGenericFamily(part) {
              ...
              "<miterlimit>": function miterlimit(part) {
                return this["<number>"](part) && part.value >= 1;
              },
              "<nonnegative-length-or-percentage>": function nonnegativeLengthOrPercentage(part) {
                return (this["<length>"](part) || this["<percentage>"](part)) && (String(part) === "0" || part.type === "function" || part.value >= 0);
              },
              "<nonnegative-number-or-percentage>": function nonnegativeNumberOrPercentage(part) {
              ...
              "<opacity-value>": function opacityValue(part) {
        ...
        24: [function (require, module, exports) {
          ...
          StringReader.prototype = {
            ...
            peekCount: function peekCount(count) {
        ...
        27: [function (require, module, exports) {
          ...
          TokenStreamBase.prototype = {
            ...
            mustMatch: function mustMatch(tokenTypes) {
              var token;
              if (!(tokenTypes instanceof Array)) {
                tokenTypes = [tokenTypes];
              }
    ...
    Reporter.prototype = {
      ...
      isIgnored: function isIgnored(line) {
        "use strict";
    ...
    CSSLint.addRule({
      ...
      init: function init(parser, reporter) {
        ...
        var endRule = function endRule(event) {
