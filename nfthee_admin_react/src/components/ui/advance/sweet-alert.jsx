              ...
              <Col sm="12">
                <Card>
                  ...
                  <CardBody  className="btn-showcase">
                    ...
                    <Button color="primary" className="sweet-2"  name="basictitlealert" onClick={(e) => Displayalert(e.target.name)}>With Title alert</Button>
                    <Button color="success" className="sweet-3"  name="basicsuccessalert" onClick={(e) => Displayalert(e.target.name)}>Success alert</Button>
                    <Button color="info" className="sweet-4"     name="basicinfoalert" onClick={(e) => Displayalert(e.target.name)}>Info alert</Button>
                    <Button color="warning" className="sweet-5"  name="basicwarningalert" onClick={(e) => Displayalert(e.target.name)}>Warning alert</Button>
                  </CardBody>
                </Card>
              </Col>
              <Col sm="12">
