...
const Ribbons = () => {
        ...
        return (
            <Fragment>
                <Breadcrumb title="Ribbons" parent="Advance"/>
                ...
                <Container fluid={true}>
                    ...
                    <Row>
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-left-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-primary ribbon-vertical-left"><i
                        ...
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-left-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-success ribbon-vertical-left"><i
                                        className="icon-signal"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                            </div>
                    ...
                    <Row>
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-right-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-primary ribbon-vertical-right"><i
                                        className="fa fa-chain-broken"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                            </div>
                        ...
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-right-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-secondary ribbon-vertical-right"><i
                                        className="fa fa-ticket"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                            </div>
                        ...
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-right-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-success ribbon-vertical-right"><i
                                        className="fa fa-taxi"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                            </div>
                    ...
                    <Row>
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-left-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-bookmark ribbon-vertical-left ribbon-primary"><i
                                        className="icofont icofont-love"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                        ...
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-left-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-bookmark ribbon-vertical-left ribbon-secondary"><i
                                        className="icon-gift"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                        ...
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-left-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-bookmark ribbon-vertical-left ribbon-success"><i
                                        className="icon-signal"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                    ...
                    <Row>
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-right-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-bookmark ribbon-vertical-right ribbon-primary"><i
                                        className="icofont icofont-love"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                        ...
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-right-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-bookmark ribbon-vertical-right ribbon-secondary"><i
                                        className="icon-gift"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
                        ...
                        <Col sm="14" xl="4">
                            <div className="ribbon-vertical-right-wrapper card">
                                <CardBody>
                                    <div className="ribbon ribbon-bookmark ribbon-vertical-right ribbon-success"><i
                                        className="icon-signal"></i></div>
                                    <p> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text.</p>
                                </CardBody>
