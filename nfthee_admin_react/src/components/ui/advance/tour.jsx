                            ...
                            <Row >
                              <Col md="6">
                                <div className="ttl-info text-left">
                                  <h6><i className="fa fa-envelope"></i>   Email</h6><span>Marekjecno@yahoo.com</span>
                                </div>
                              </Col>
                              <Col md="6">
                      ...
                      <div className="profile-img-style">
                        ...
                        <div className="img-container">
                          <div id="aniimated-thumbnials">
                              <a href="#javaScript">
                                  <Media  className="img-fluid rounded" src={require("../../../assets/images/profile-style-img3.png")} alt="gallery"/>
                              </a>
                          </div>
                        </div>
                      ...
                      <div className="profile-img-style">
                        ...
                        <Row className="mt-4 pictures">
                          <a className="col-sm-6" href="#javaScript">
                              <Media body className="img-fluid rounded" src={require("../../../assets/images/profile-style-img.png")} alt="gallery"/>
                          </a>
                          <a className="col-sm-6" href="#javaScript">
                            <Media body className="img-fluid rounded" src={require("../../../assets/images/profile-style-img.png")} alt="gallery"/>
                          </a>
