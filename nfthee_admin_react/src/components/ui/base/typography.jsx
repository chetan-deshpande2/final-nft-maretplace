...
const Typography = () => {
    ...
    return (
        <Fragment>
            <Breadcrumb title="Typography" parent="Base" />
            ...
            <Row>
                ...
                <Card>
                    ...
                    <Row>
                      ...
                      <Col sm="12" xl="6">
                        <p className="h1 txt-primary">Heading 1<small>Sub Heading</small></p>
                        <p className="h2 txt-secondary">Heading 2<small>Sub Heading</small></p>
                        <p className="h3 txt-success">Heading 3<small>Sub Heading</small></p>
                        <p className="h4 txt-info">Heading 4<small>Sub Heading</small></p>
                        <p className="h5 txt-warning">Heading 5<small>Sub Heading</small></p>
                        <p className="h6 txt-danger">Heading 6<small>Sub Heading</small></p>
                      </Col>
                    </Row>
                  </CardBody>
                </Card>
              ...
              <Col sm="12" xl="6">
                <Card>
                  <CardHeader>
                    <h5>Text Color</h5><span>You can Give text color by using txt-* className</span>
                  </CardHeader>
                  <CardBody>
