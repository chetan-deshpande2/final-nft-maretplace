...
const Grid = () => {
        ...
        return (
            <Fragment>
                <Breadcrumb title="Grid" parent="Base" />
                    ...
                    <Col sm="12">
                        ...
                        <CardBody className="card-body">
                            ...
                            <Table bordered striped>
                                ...
                                <tr>
                                    <th></th>
                                    <th className="text-center">Extra small<br/><small className="digits">&lt;576px</small></th>
                                    ...
                                    <th className="text-center">Extra large<br/><small className="digits">≥1200px</small></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
