        ...
        <Fragment>
            ...
            <Container fluid={true}>
                    ...
                    <CardBody className="btn-showcase">
                        <Button color="primary" onClick={toggle}>Simple</Button>
                            <Modal isOpen={modal} toggle={toggle} >
                                ...
                                <Button color="secondary" onClick={toggle}>Save changes</Button>
                                </ModalFooter>
                            </Modal>
                        <Button color="primary" onClick={Scrollmodaltoggle}>Scrolling long content</Button>
                        <Modal isOpen={scrollingmodal} toggle={Scrollmodaltoggle}>
                            ...
                            <ModalFooter>
                                ...
                                <Button color="primary"   onClick={Scrollmodaltoggle}>Save changes</Button>
                            </ModalFooter>
                        </Modal>
                        <Button color="primary" onClick={Verticalcentermodaltoggle}>Vertically centered</Button>
                        <Modal isOpen={Verticalcenter} toggle={Verticalcentermodaltoggle} centered>
                            ...
                            <ModalFooter>
                                ...
                                <Button color="primary"  onClick={Verticalcentermodaltoggle}>Save changes</Button>
                            </ModalFooter>
                        </Modal>
                        <Button color="primary" onClick={Tooltippopovermodaltoggle}>Tooltips and popovers</Button>
                        <Modal isOpen={tooltippopover} toggle={Tooltippopovermodaltoggle} centered>
                            ...
                            <ModalBody>
                                ...
                                <p>This <button className="btn btn-primary popover-test" href="#javaScript" >button</button> triggers a popover on click.</p>
                                <hr/>
                            ...
                            <ModalFooter>
                                ...
                                <Button color="primary"  onClick={Tooltippopovermodaltoggle}>Save changes</Button>
                            </ModalFooter>
                        </Modal>
                        <Button color="primary" onClick={Gridmodaltoggle}>Using the grid</Button>
                        <Modal isOpen={grid} toggle={Gridmodaltoggle}>
                            ...
                            <ModalFooter>
                                ...
                                <Button color="primary"  onClick={Gridmodaltoggle}>Save changes</Button>
                            </ModalFooter>
                        </Modal> 
                    </CardBody>
                    </Card>
                    ...
                    <CardBody className="btn-showcase">
                        ...
                        <Modal isOpen={VaryingContentone} toggle={VaryingContentonetoggle}>
                            ...
                            <ModalFooter>
                                    ...
                                    <Button color="primary" onClick={VaryingContentonetoggle}>Send message</Button>
                            </ModalFooter>
                        </Modal>
                        <Modal isOpen={VaryingContenttwo} toggle={VaryingContenttwotoggle}>
                            ...
                            <ModalFooter>
                                    ...
                                    <Button color="primary" onClick={VaryingContenttwotoggle}>Send message</Button>
                            </ModalFooter>
                        </Modal>
                        <Modal isOpen={VaryingContentthree} toggle={VaryingContentthreetoggle}>
                            ...
                            <ModalFooter>
                                    ...
                                    <Button color="primary" onClick={VaryingContentthreetoggle}>Send message</Button>
                            </ModalFooter>
                        </Modal>
                    </CardBody>
                    </Card>
                ...
                <Col sm="12">
                    ...
                    <CardBody className="btn-showcase">
                        <Button color="primary" onClick={LargeModaltoggle}>Large modal</Button>
                        ...
                        <Button color="primary" onClick={SmallModaltoggle}>Small modal</Button>
