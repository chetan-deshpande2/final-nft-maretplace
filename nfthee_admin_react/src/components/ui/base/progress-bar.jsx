            ...
            <Fragment>
                ...
                <Container fluid={true}>
                    ...
                    <Col sm="12">
                        ...
                        <CardBody className="card-body progress-showcase row">
                            <Col>
                            <Progress color="primary" value="25" className="xs-progress-bar" style={{height: '1px'}} />
                            <Progress  color="secondary" value="50" className="sm-progress-bar" style={{height: '5px'}} />
                            <Progress  color="success" value="75" className="md-progress-bar" style={{height: '11px'}} />
