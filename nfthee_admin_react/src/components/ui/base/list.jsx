...
const  List = (props) => {
    ...
    return (
      <Fragment>
        <Breadcrumb title="Lists" parent="Base" />
                    ...
                    <Row>
                      <Col sm="4" className="tab-javascript">
                            <ListGroup className="nav-primary nav-pills">
                              <ListGroupItem  href="#javascript"  className={activeTab === '1' ? 'list-group-item-action active' : ''} onClick={() => setActiveTab('1')}>Home</ListGroupItem>
                            </ListGroup>
                            <ListGroup>
