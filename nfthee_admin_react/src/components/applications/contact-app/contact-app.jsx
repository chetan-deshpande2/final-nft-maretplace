...
const ContactApp = (props) => {
    ...
    const redirectUrl = () => {
        history.push(`${process.env.PUBLIC_URL}/applications/new-user`);
    }

    const editContact = (user) => {
        history.push(`${process.env.PUBLIC_URL}/applications/edit-user/${user.id}`);
    }

    return (
        <Fragment>
            <Breadcrumb title="Contact" parent="Contact App" />
                                                ...
                                                {users.map((user, index) => {
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                                <h6 className="digits">{user.mobile}</h6>
                                                            </td>
                                                            <td>
                                                                <h6 className="digits">{user.age}</h6>
                                                            </td>
                                                            <td>
