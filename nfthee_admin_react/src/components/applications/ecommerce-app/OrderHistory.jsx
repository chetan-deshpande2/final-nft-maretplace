                ...
                <div className="order-history table-responsive">
                  <Table borderless>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/1.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/13.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/4.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/10.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/12.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/3.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/2.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/15.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/14.png")} alt="#"/></td>
                        <td>
                      ...
                      <tr>
                        <td><Media className="img-fluid img-60" src={require("../../../assets/images/product/11.png")} alt="#"/></td>
                        <td>
